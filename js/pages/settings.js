                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center">
                        <div class="position-relative d-inline-block mx-auto mb-3">
                            <div class="bg-orange text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 100px; height: 100px; font-size: 2.5rem; font-weight: bold;">
                                ${user.fname.charAt(0).toUpperCase()}
                            </div>
                            <button class="btn btn-primary btn-sm rounded-circle position-absolute bottom-0 end-0 p-2 shadow" title="Change Photo">
                        ...
                        <form id="settings-profile-form">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control rounded-3 py-2" placeholder="+1 234 567 890">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12 text-end mt-4">
                                    <button type="button" class="btn btn-primary rounded-pill px-4 py-2 fw-bold" onclick="alert('Profile updated successfully!')">Save Changes</button>
                                </div>
                            </div>
                        </form>
                    </div>
